  ...
  <path d="M32 15H3.41l8.29-8.29-1.41-1.42-10 10a1 1 0 0 0 0 1.41l10 10 1.41-1.41L3.41 17H32z" data-name="4-Arrow Left"/>
   ...
   <h1 className='text-2xl font-semibold flex text-black pl-2'>Checkout</h1>
        ...
        <div className='mt-8'>
          ...
          <div className="bg-slate-50 w-auto h-auto mx-4">
            <div className="w-full h-1/2">
              <div className="card mt-1 bg-white-800 shadow-sm">
                <div className="card-body">
                  <h1>Order Type</h1>
                  <div id='cb1' className='flex justify-between py-2 text-md font-bold'>
                    <input
                      type="radio"
                      id="dine-in"
                      name="orderType"
                  ...
                  <div id='cb1' className='flex justify-between text-md font-bold'>
                    <input
                      type="radio"
                      id="takeaway"
                      name="orderType"
          ...
          <div className="bg-slate-50 w-auto h-auto mx-4 mt-4 ">
            <div className="w-full h-auto">
              <div className="card mt-1 bg-white-800 shadow-sm">
                <div className="card-body">
                <h1>Payment Option</h1>
                  <div id='cb1' className='flex justify-between py-4 text-md font-bold'>
                    <input
                      type="radio"
                      id="cash"
                      name="paymentOption"
